		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 info-left">
					<div >
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row info-content">
								<a href="<?php echo U('Home/Blog/index',array('id'=>$vo['id']));?>">
