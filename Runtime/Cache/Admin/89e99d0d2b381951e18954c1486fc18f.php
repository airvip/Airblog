						...
						<div class="col-lg-12">
							<div class="portlet box">
								<div class="panel-heading">
									...
									<div class="row">
										<div class="col-xs-5">
											<form class="navbar-form " action="<?php echo U('Admin/Blog/search');?>" method="post" role="search" >
												<div class="input-group">
													<div class="input-group-btn">
														<select class="form-control " name="name">
															<option value="title">博客标题</option>
															<option value="auther">博客作者</option>
										...
										<div class="col-xs-7">
											<div class="navbar-form text-right">
												<a href="<?php echo U('Admin/Blog/add');?>" type="button" title="新增博客" class="btn btn-success" >
													<i class="fa fa-plus-square"></i> 新增博客
												</a>
											</div>
										</div>
									</div>
									...
									<table class="table table-hover table-striped user-table">
										...
										<tbody>
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
													...
													<td>
														<div class="content-hidden" title="<?php echo ($vo['title']); ?>">
															<?php echo ($vo['title']); ?>
														</div>
													</td>
													<td>
													...
													<td>
														<div class="content-hidden" title="<?php echo ($vo['blog_info']); ?>">
															<?php echo ($vo['blog_info']); ?>
														</div>
													</td>
													<td>
													...
													<td id="user-fa">
														<a class="btn btn-primary btn-xs" href="<?php echo U('Admin/Blog/see',array('id'=>$vo['id']));?>">
															<i class="fa  fa-eye" title="查看详情"></i>
														</a> 
														 
														<a class="btn btn-warning btn-xs" href="<?php echo U('Admin/Blog/edit',array('id'=>$vo['id']));?>">
	...
	<script>
		$(function(){
			...
			$(".item-delete").click(function(){
				var rs		    = confirm('你确定删除该条记录吗?');
				var id 	= $(this).attr('attr');
				if( false == rs)return;
				$.ajax({
					type:'post',
					url:'<?php echo U("Admin/Blog/delete");?>',
					data:{
						'id':id,
					},
					dataType:"json",
